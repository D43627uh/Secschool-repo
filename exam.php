   ...
   session_start();
    ...
    if (isset($_POST['save'])) {
        ...
        $priority=$_POST['priority'];
            ...
            $sql1= "SELECT * FROM exams WHERE priority='$priority'";
        $result1=mysqli_query($db,$sql1);

        if (mysqli_num_rows($result1)>0) {

           $message = "Priority already exists please provide a new one";
            echo "<script type='text/javascript'>alert('$message');</script>";
            
        }else{
            $sql="INSERT INTO exams (priority,name) VALUES ('$priority','$name')";
            mysqli_query($db,$sql);
...
//edit class   
        ...
        if (mysqli_num_rows($result1)>0) {
           ...
           $message = "Priority already exists please provide a new one";
            echo "<script type='text/javascript'>alert('$message');</script>";
              ...
              $sql = "UPDATE exams SET priority='$priority',name='$editname'
                  WHERE id='$editid' ";
              mysqli_query($db,$sql);
            header("location: exam.php");
          }
        ...
        if(isset($_POST['delete'])){
              ...
              $sql = "DELETE FROM exams WHERE id='$deleteid' ";
              mysqli_query($db,$sql);
            header("location: exam.php");
          }
?>
          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              ...
              <!--<div class="panel-body">-->
                <input type="submit" name="add" class="btn btn-info" value="Add New Exam" data-toggle="modal" data-target="#add">
                <div><br></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
      <label>Enter Exam Name</label><input type="text" name="name" class="form-control">
    </div>
    </div>
