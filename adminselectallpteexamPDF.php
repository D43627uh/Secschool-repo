<?php 
  ...
  $pdf->cell(280, 10, "TAMBACH TEACHERS' COLLEGE", 0, 1, 'C');

  $pdf->setFont('Arial','',11);
  $pdf->cell(280, 7, "P.O PRIVATE BAG", 0, 1, 'C');
  $pdf->cell(280, 7, "ITEN-TAMBACH", 0, 1, 'C');

  $pdf->cell(280, 7, "RESULT TRANSCRIPT", 0, 1, 'C');


  
  $pdf-> Image($image1,10,5,35,35); 
$pdf-> Image($image,255,5,35,35);
