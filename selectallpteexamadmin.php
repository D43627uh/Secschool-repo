<?php 
   session_start();
    ...
    if (isset($_POST['selectall'])) {
      ...
      header("location: adminselectallpteexam.php");
       }
       else if($classes=="Second Year")
       {
        $_SESSION['classes']=$classes;
      $_SESSION['categories']=$categories;
      $_SESSION['terms']=$terms;
      ...
      $_SESSION['streams']=$streams;
      $_SESSION['acyear']=$acyear;
      header("location: adminselectallpteexamsecond.php");
       }
          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">PTE Results</h3>
              </div>
              <br>
