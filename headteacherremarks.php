       ...
       $sql1= "SELECT * FROM headteachers WHERE username='$username'";
        ...
        if (mysqli_num_rows($result1)>0) {
          ...
          $name=$row1['name'];
            ...
            $sql="INSERT INTO headteacherremarks(username,name,acyear,grade,remarks) VALUES ('$username','$name','$acyear','$grade','$remarks')";
...
//edit teacher    
        if(isset($_POST['updateTeacher'])){
              ...
              $sql = "UPDATE headteacherremarks SET grade='$grade',remarks='$remarks' WHERE id='$editid' ";
              mysqli_query($db,$sql);
            header("location: headteacherremarks.php");
          }
        ...
        if(isset($_POST['deleteTeacher'])){
              ...
              $sql = "DELETE FROM headteacherremarks WHERE id='$deleteid' ";
              mysqli_query($db,$sql);
            header("location: headteacherremarks.php");
          }
?>
              ...
              <!--<div class="panel-body">-->
                ...
                <!--table from here-->
                 <table class="table table-bordered">
                  ...
                  <?php 
                   $sql= "SELECT * FROM headteacherremarks";
