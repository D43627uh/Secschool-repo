<?php 
   session_start();
    ...
    if (isset($_POST['selectall'])) {
      header("location: adminselectallpteexamPDFsecond.php");
    ...
    <section id="main">
      ...
      $sqlmarks= "SELECT * FROM examptemarks WHERE indexnumber='$indexnumber' AND category='$s_category' AND exam='$s_exam' AND  class='$s_class' AND subject='Mathematics'";
        ...
        ?>
                ...
                <td>
                   <?php
      $sqlmarks= "SELECT * FROM examptemarks WHERE indexnumber='$indexnumber' AND category='$s_category' AND exam='$s_exam' AND  class='$s_class' AND subject='Science'";
        $resultmarks = mysqli_query($db, $sqlmarks);
      ...
      $sqlmarks= "SELECT * FROM examptemarks WHERE indexnumber='$indexnumber' AND category='$s_category' AND exam='$s_exam' AND  class='$s_class' AND subject='ICT'";
        ...
        ?>
                 ...
                 <td>
                    <?php
      $sqlmarks= "SELECT * FROM examptemarks WHERE indexnumber='$indexnumber' AND category='$s_category' AND exam='$s_exam' AND  class='$s_class' AND subject='Agriculture'";
        $resultmarks = mysqli_query($db, $sqlmarks);
        ...
        ?>
                 ...
                 <td>
                    <?php
      $sqlmarks= "SELECT * FROM examptemarks WHERE indexnumber='$indexnumber' AND category='$s_category' AND exam='$s_exam' AND  class='$s_class' AND subject='Home Science'";
        $resultmarks = mysqli_query($db, $sqlmarks);
        ...
        ?>
                 ...
                 <td>
                    <?php
      $sqlmarks= "SELECT * FROM examptemarks WHERE indexnumber='$indexnumber' AND category='$s_category' AND exam='$s_exam' AND  class='$s_class' AND subject='Music'";
        $resultmarks = mysqli_query($db, $sqlmarks);
