       ...
       $sql1= "SELECT * FROM teachers WHERE username='$username'";
        ...
        if (mysqli_num_rows($result1)>0) {
          ...
          $name=$row1['name'];
            ...
            $sql="INSERT INTO classteachers (class,stream,acyear,username,name) VALUES ('$class','$stream','$acyear','$username','$name')";
            
            mysqli_query($db,$sql);
            
            header("location: classteachers.php");
 }
        }
      }
...
//edit teacher    
        if(isset($_POST['updateTeacher'])){
              ...
              $sql = "UPDATE classteachers SET name='$editname',initials='$editinitials',username='$editusername',password='$editpassword'
                  WHERE id='$editid' ";
              mysqli_query($db,$sql);
            header("location: classteachers.php");
          }
        ...
        if(isset($_POST['deleteTeacher'])){
              ...
              $sql = "DELETE FROM classteachers WHERE id='$deleteid' ";
              mysqli_query($db,$sql);
            header("location: classteachers.php");
          }
?>
          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Assign Class Teachers</h3>
              </div>
              <br>
              <!--<div class="panel-body">-->
                <input type="submit" name="addteacher" class="btn btn-info" value="Assign Classes" data-toggle="modal" data-target="#addTeacher">
                <div><br></div>
