      ...
      {   
        ...
        if (mysqli_num_rows($result1)>0) {
           ...
           $message = "Username already exists please provide a new one";
            ...
            header("location: admissioncred.php");
          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Admission Credentials</h3>
              </div>
              <br>
               <input type="submit" name="add" class="btn btn-info" value="Add Admission Credentials" data-toggle="modal" data-target="#addAdmin">
                <div><br></div>
                ...
                <!--table from here-->
                 <table class="table table-bordered">
                  ...
                  <?php 
                   $sql= "SELECT * FROM users WHERE category='Admission'";
