...
session_start();
    ...
    if (isset($_POST['selectall'])) {
      ...
      $streams=$_POST['streams'];
        ...
        $sql1= "SELECT * FROM classteachers WHERE username='$username' AND class='$classes' AND stream='$streams' AND acyear='$acyear'";
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Class Teacher Remarks</h3>
              </div>
              <br>
              <form method="post">
