   ...
   session_start();
    ...
    if (isset($_POST['save'])) {
        ...
        $name=$_POST['name'];
            ...
            $sql1= "SELECT * FROM streams WHERE name='$name'";
        ...
        if (mysqli_num_rows($result1)>0) {
           ...
           $message = "Subject name already exists please provide a new one";
            ...
            $sql="INSERT INTO streams (name) VALUES ('$name')";
            mysqli_query($db,$sql);
...
//edit class   
        if(isset($_POST['update'])){
              ...
              $sql = "UPDATE streams SET name='$editname'
                  WHERE id='$editid' ";
              mysqli_query($db,$sql);
            header("location: stream.php");
          }
        ...
        if(isset($_POST['delete'])){
              ...
              $sql = "DELETE FROM streams WHERE id='$deleteid' ";
              mysqli_query($db,$sql);
            header("location: stream.php");
          }
?>
          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              ...
              <!--<div class="panel-body">-->
                <input type="submit" name="add" class="btn btn-info" value="Add New Stream" data-toggle="modal" data-target="#add">
                <div><br></div>
...
<!--Delete Class -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <label>Enter Stream Name</label><input type="text" name="name" class="form-control">
    </div>
    </div>
